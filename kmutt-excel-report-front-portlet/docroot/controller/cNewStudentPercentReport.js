var restfulPathDropDownYear="/"+serviceName+"/public/NewStudent/YearList";
var restfulPathDropDownFaculty="/"+serviceName+"/public/NewStudent/FacultyList";
var restfulPathImportExcel ="/"+serviceName+"/public/NewStudent/Import/Percent";
var restfulPathExportExcel ="/"+serviceName+"/public/NewStudent/Export/Percent";
...
var gerReportFn = function() {
	...
	parameter = {
	  ...
	  var url_report_jasper = restfulURL+"/"+serviceName+"/public/generate?template_name=new_student_percent_report&template_format="+param_type+"&used_connection=1&inline=1&data="+data;
