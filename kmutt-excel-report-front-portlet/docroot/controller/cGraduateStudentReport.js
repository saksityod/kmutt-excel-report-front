...
var restfulPathImportExcel = apiURL+"/GraduateStudent/Import";
var restfulPathExportExcel = apiURL+"/GraduateStudent/Export";
...
var gerReportFn = function() {
	...
	parameter = {
	  ...
	  var url_report_jasper = apiURL+"/generate?template_name=graduate_student_report&template_format="+param_type+"&used_connection=1&inline=1&data="+data+"&subreport_bundle=1";
