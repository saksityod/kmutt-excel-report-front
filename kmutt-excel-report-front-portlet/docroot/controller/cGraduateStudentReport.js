...
var restfulPathImportExcel ="/"+serviceName+"/public/GraduateStudent/Import";
var restfulPathExportExcel ="/"+serviceName+"/public/GraduateStudent/Export";
...
var gerReportFn = function() {
	...
	parameter = {
	  ...
	  var url_report_jasper = restfulURL+"/"+serviceName+"/public/generate?template_name=graduate_student_report&template_format="+param_type+"&used_connection=1&inline=1&data="+data;
