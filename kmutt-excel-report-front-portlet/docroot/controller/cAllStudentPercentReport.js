...
var restfulPathImportExcel = apiURL+"/AllStudent/Import/Percent";
var restfulPathExportExcel = apiURL+"/AllStudent/Export/Percent";
...
var gerReportFn = function() {
	...
	parameter = {
	  ...
	  var url_report_jasper = apiURL+"/generate?template_name=all_student_percent_report&template_format="+param_type+"&used_connection=1&inline=1&data="+data+"&subreport_bundle=1";
