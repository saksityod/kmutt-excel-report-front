...
var restfulPathImportExcel ="/"+serviceName+"/public/AllStudent/Import/Percent";
var restfulPathExportExcel ="/"+serviceName+"/public/AllStudent/Export/Percent";
...
var gerReportFn = function() {
	...
	parameter = {
	  ...
	  var url_report_jasper = restfulURL+"/"+serviceName+"/public/generate?template_name=all_student_percent_report&template_format="+param_type+"&used_connection=1&inline=1&data="+data;
