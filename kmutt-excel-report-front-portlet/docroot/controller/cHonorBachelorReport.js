var restfulPathDropDownYear="/"+serviceName+"/public/Honor/YearList";
var restfulPathDropDownFaculty="/"+serviceName+"/public/Honor/FacultyList";
var restfulPathImportExcel ="/"+serviceName+"/public/Honor/Import/HonorBachelor";
var restfulPathExportExcel ="/"+serviceName+"/public/Honor/Export";
...
var gerReportFn = function() {
	...
	parameter = {
	  ...
	  var url_report_jasper = restfulURL+"/"+serviceName+"/public/generate?template_name=honor_bachelor_report&template_format="+param_type+"&used_connection=1&inline=1&data="+data;
