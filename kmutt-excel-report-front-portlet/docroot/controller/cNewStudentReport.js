...
var restfulPathImportExcel = apiURL+"/NewStudent/Import";
var restfulPathExportExcel = apiURL+"/NewStudent/Export";
...
var gerReportFn = function() {
	...
	parameter = {
	  ...
	  var url_report_jasper = apiURL+"/generate?template_name=new_student_report&template_format="+param_type+"&used_connection=1&inline=1&data="+data+"&subreport_bundle=1";
