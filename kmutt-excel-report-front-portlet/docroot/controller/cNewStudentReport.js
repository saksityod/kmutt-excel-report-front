...
var restfulPathImportExcel ="/"+serviceName+"/public/NewStudent/Import";
var restfulPathExportExcel ="/"+serviceName+"/public/NewStudent/Export";
...
var gerReportFn = function() {
	...
	parameter = {
	  ...
	  var url_report_jasper = restfulURL+"/"+serviceName+"/public/generate?template_name=new_student_report&template_format="+param_type+"&used_connection=1&inline=1&data="+data;
