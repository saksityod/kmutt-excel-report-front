var restfulPathDropDownYear="/"+serviceName+"/public/GraduateStudent/YearList";
var restfulPathDropDownFaculty="/"+serviceName+"/public/GraduateStudent/FacultyList";
var restfulPathImportExcel ="/"+serviceName+"/public/GraduateStudent/Import/Percent";
var restfulPathExportExcel ="/"+serviceName+"/public/GraduateStudent/Export/Percent";
...
var gerReportFn = function() {
	...
	parameter = {
	  ...
	  var url_report_jasper = restfulURL+"/"+serviceName+"/public/generate?template_name=graduate_student_percent_report&template_format="+param_type+"&used_connection=1&inline=1&data="+data;
