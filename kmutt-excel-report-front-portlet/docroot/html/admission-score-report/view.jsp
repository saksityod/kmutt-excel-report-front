	...
	<div class="panel panel-primary " id="panel_advanced_search"
		...
		<div class="panel-body">
			...
			<div class="row-fluid ">
				...
				<div class="form-group pull-left span3" style="margin-left: 5px">
					<select data-original-title="คณะ/สาขา" data-toggle="tooltip" title="" class="input span12 m-b-n" id="param_faculty_field" name="param_faculty_field" style="cursor: pointer;">
						<option  value="">คณะ/สาขาทั้งหมด</option>
					</select>
				</div>
				<div class="form-group pull-left span3" style="margin-left: 5px">
